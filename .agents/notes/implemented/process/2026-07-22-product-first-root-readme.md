...
The downstream desktop distribution's [multilingual project README](2026-08-16-multilingual-desktop-project-readme.md) supersedes only this structure-preservation requirement for the root landing page. The product-first scope, compact capability inventory, and links to owning documentation remain current.
