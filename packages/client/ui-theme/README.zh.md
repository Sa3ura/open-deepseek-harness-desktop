...
- **第三方主题是扩展点，不是产品**：注册主题意味着覆盖同名别名变量；目前不会验证一组覆盖是否完整。七个命名产品皮肤是完整内置项，并会跨越 Host settings schema。
